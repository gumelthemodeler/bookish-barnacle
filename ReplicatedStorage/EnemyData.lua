...
EnemyData.WorldBosses = {
	...
	["Doomsday Titan"] = { Name = "The Doomsday Titan", Desc = "Eren's skeletal monstrosity leading the Rumbling. Commands pure titans at will.", IsBoss = true, IsDoomsdayBoss = true, Health = 12000, GateType = "Steam", GateHP = 10, Strength = 800, Defense = 1000, Speed = 50, Resolve = 1000, TitanStats = {Power="S", Speed="E", Hardening="S", Endurance="S", Precision="S", Potential="S"}, Skills = {"Coordinate Command", "Colossal Steam", "Stomp"}, Drops = { XP = 600000, Dews = 60000, ItemChance = { ["Spinal Fluid Syringe"] = 10, ["Clan Blood Vial"] = 8, ["Ymir's Clay Fragment"] = 3, ["Glowing Titan Crystal"] = 25, ["Coordinate Shard"] = 1, ["Founder's Bone"] = 0.5 } } },
	["Ymir Fritz"] = { Name = "Ymir Fritz (Founder)", Desc = "The original progenitor. She molds the world in the Paths. The ultimate trial.", IsBoss = true, IsDoomsdayBoss = true, Health = 15000, GateType = "Hardening", GateHP = 5000, Strength = 1000, Defense = 1500, Speed = 200, Resolve = 5000, TitanStats = {Power="S", Speed="S", Hardening="S", Endurance="S", Precision="S", Potential="S"}, Skills = {"Coordinate Command", "War Hammer Spike", "Colossal Steam", "Armored Tackle"}, Drops = { XP = 1500000, Dews = 100000, ItemChance = { ["Spinal Fluid Syringe"] = 15, ["Clan Blood Vial"] = 10, ["Ymir's Clay Fragment"] = 5, ["Coordinate Shard"] = 2, ["Abyssal Blood"] = 4, ["Founder's Bone"] = 1.0 } } },

	-- [[ THE RUMBLING EVENT BOSS ]]
	["Rumbling Horde"] = { 
		Name = "Wall Titan", 
		Desc = "A colossal Wall Titan marching forward. Kill as many as you can before they trample the world.", 
		IsBoss = true, 
		IsRumblingBoss = true,
		Health = 400, 
		GateType = "Steam", GateHP = 2, 
		Strength = 300, Defense = 80, Speed = 20, Resolve = 60, 
		TitanStats = emptyTitans, 
		Skills = {"Colossal Steam", "Stomp", "Brutal Swipe"}, 
		Drops = { XP = 1200, Dews = 1000 } 
	}
}
...
EnemyData.Parts = {
	...
	[8] = {
		...
		Templates = {
			...
			["Part8Boss"] = { IsBoss = true, Name = "Founding Titan", Health = 3500, GateType = "Steam", GateHP = 3, Strength = 350, Defense = 150, Speed = 15, Resolve = 150, TitanStats = {Power="S", Speed="E", Hardening="S", Endurance="S", Precision="S", Potential="S"}, Skills = {"Coordinate Command", "Colossal Steam", "War Hammer Spike"}, Drops = { Dews = 6000, XP = 35000, ItemChance = { ["Ymir's Clay Fragment"] = 2, ["Spinal Fluid Syringe"] = 5, ["Founder's Bone"] = 0.5 } }, Phases = { { Health = 1500, GateType = "Hardening", GateHP = 1500, Strength = 500, Defense = 200, Speed = 40, Skills = {"Coordinate Command", "War Hammer Spike"}, Flavor = "<font color=\"#FFD700\"><b>Ymir interferes! The Founding Titan is covered in crystal hardening!</b></font>" } } },
